...
describe GamesController do
  ...
  let(:valid_attributes) { { "start_at" => "2013-09-25 16:16:10" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "start_at" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update).with({ "start_at" => "2013-09-25 16:16:10" })
        put :update, {:id => game.to_param, :game => { "start_at" => "2013-09-25 16:16:10" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "start_at" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
